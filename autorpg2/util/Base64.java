...
public class Base64 {
    ...
    public static byte[] encodeBytesToBytes(byte[] bArr) {
        try {
            ...
            Log.e("Base64", "IOExceptions only come from GZipping, which is turned off: " + e.getMessage());
            return null;
        }
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:59:0x0059
    ...
    public static byte[] decode(java.lang.String r5, int r6) throws java.lang.Throwable {
        ...
        L8d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shirobakama.autorpg2.util.Base64.decode(java.lang.String, int):byte[]");
    }
        ...
        try {
            ...
            try {
                if (classLoader == null) {
                    ...
                    objectInputStream = new ObjectInputStream(byteArrayInputStream) { // from class: com.shirobakama.autorpg2.util.Base64.1
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int i) throws IOException {
            ...
            if (this.encode) {
                ...
                bArr[i2] = (byte) i;
                if (this.position >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f112b4, this.buffer, this.bufferLength, this.options));
                    this.lineLength += 4;
            ...
            if (bArr2[i3] > -5) {
                ...
                bArr3[i4] = (byte) i;
                if (this.position >= this.bufferLength) {
                    this.out.write(this.f112b4, 0, Base64.decode4to3(bArr3, 0, this.f112b4, 0, this.options));
                    this.position = 0;
                    return;
                }
                return;
        ...
        public void flushBase64() throws IOException {
            if (this.position > 0) {
                if (this.encode) {
                    this.out.write(Base64.encode3to4(this.f112b4, this.buffer, this.position, this.options));
                    this.position = 0;
                    return;
                }
