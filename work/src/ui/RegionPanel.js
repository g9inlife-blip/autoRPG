(() => {
  ...
  // 탐험 중에도 던전/여관/상점/기타 탭은 자유롭게 열람한다. 실제 상태 변경만 제한한다.
  ...
  syncControls();
  if(!document.querySelector('script[data-exploration-control]')){const script=document.createElement('script');script.src='src/ui/ExplorationControl.js?v=20260903-3';script.dataset.explorationControl='1';document.body.appendChild(script);}
})();
